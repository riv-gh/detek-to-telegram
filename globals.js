...
const NOT_SHUTDONW_TEXT = `За вашою адресою в даний момент відсутня інформація про планові відключення електроенергії. Якщо у вас відсутнє світло, ймовірно виникла аварійна ситуація, або діють стабілізаційні або екстрені відключення.`
